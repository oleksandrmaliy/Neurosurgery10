        ...
        <div className={css.section}>
          ...
          <div className={css.subsection}>
            ...
            <p className={css.textIndent}>
              ...
              висококвалiфiкованих лiкарiв iз багаторiчним досвiдом роботи. У
              нашiй командi є як молодi фахiвцi, так i досвiдченi лiкарi, чий
              професiйний шлях у медицинi триває вже не одне десятилiття. Кожен
              iз наших лiкарiв постiйно вдосконалює свої знання та навички, щоб
              вiдповiдати сучасним стандартам медичної допомоги.
            </p>
            <p className={css.textIndent}>
              Нашi лiкарi – це основа якостi та надiйностi терапевтичного
              вiддiлення. Завдяки їхньому професiоналiзму, вiдданостi роботi та
              iндивiдуальному пiдходу до кожного пацiєнта, ми гарантуємо високий
              рiвень медичних послуг. Вони дбають про здоров&apos;я наших
              пацiєнтiв, приймають найкращi рiшення для ефективного лiкування та
              створюють атмосферу довiри й турботи.
            </p>
            <p className={css.textIndent}>
        ...
        <div className={css.section}>
          ...
          <div className={css.subsection}>
            ...
            <div className={css.interiorCard}>
              ...
              <div className={css.textInterior}>
                <p>
                  Терапевтичне відділення ЛШМД. Колектив турботи і
                  професіоналізму. Дякуємо.
                </p>
              </div>
            </div>
          </div>
