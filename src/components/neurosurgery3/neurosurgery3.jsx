import css from './neurosurgery3.module.css';

function Neurosurgery3() {
  return (
    <>
      <div className={css.container}>
        <h2 className={css.pageHeader}>
          Нейрохірургічне відділення №3
          <br />
          (хірургії хребта та спинного мозку)
        </h2>
        <div className={css.section}>
          ...
          <div className={css.subsection}>
            ...
            <p className={css.textIndent}>пацієнтів.</p>
                ...
                <ul className={css.textIndent}>
                  <li>
                    <p>
                      ...
                      поперекового та грудного відділів хребта, що потребують
                      хірургічного втручання;
                    </p>
                  </li>
                  <li>
                    <p>b) травматичні протрузії та кили міжхребцевих дисків;</p>
                  </li>
                  <li>
                    <p>
                      c) травматичні ушкодження краніо-вертебральної ділянки;
                    </p>
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul className={css.textIndent}>
                  <li>
                    ...
                    <ul>
                      <li>
                        <p>i) шийна мієлопатія;</p>
                      </li>
                      <li>
                        <p>ii) радикулярний больовий синдром;</p>
                      </li>
                      <li>
                        <p>iii) стеноз каналу хребта;</p>
                      </li>
                    </ul>
                  </li>
                  <li>
                    <p>b) грудного відділу:</p>
                    <ul>
                      <li>
                        <p>i) грудна мієлопатія;</p>
                      </li>
                    </ul>
                  </li>
                  <li>
                    <p>c) поперекового відділу:</p>
                    <ul>
                      <li>
                        <p>i) радикулярний больовий синдром;</p>
                      </li>
                      <li>
                        <p>ii) стеноз каналу хребта;</p>
                      </li>
                      <li>
                        <p>iii) спонділолістез;</p>
                      </li>
                    </ul>
                  </li>
                </ul>
            ...
            <ul>
              <li>
                ...
                <ul className={css.textIndent}>
                  ...
                  <li>
                    <p>b) корпородез на всіх відділах хребта;</p>
                  </li>
                  <li>
                    <p>c) мікродискектоміяна всіх відділах хребта;</p>
                  </li>
                  <li>
                    <p>
                      d) стабілізуючі операції хребта (транспедикулярна,
                      транскутанна);
                    </p>
                  </li>
                  <li>
                    <p>e) кіфопластика та вертебропластика;</p>
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul className={css.textIndent}>
                  ...
                  <li>
                    <p>b) операції на краніо-вертебральному переході;</p>
                  </li>
                </ul>
              </li>
            </ul>
          ...
          <div className={css.subsection}>
            ...
            <p className={css.textIndent}>
              ...
              допомогу пацієнтам у критичних станах.
            </p>
            <p className={css.textIndent}>
          ...
          <div className={css.subsection}>
            ...
            <p className={css.textIndent}>
              <a href="tel:+380445276969" className={css.tel}>
                (044) 527–69–69
              </a>{' '}
